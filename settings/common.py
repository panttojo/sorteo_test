...
SITE_NAME = env("SITE_NAME", default="Talana")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="Talana")
...
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[Talana] ")
...
STATIC_URL = env("MEDIA_URL", default="/static/")
